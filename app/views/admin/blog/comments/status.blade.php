...
@section('content')
    ...
    @if($status_comment==1)
        <p class="text-muted text-center">کامنت های خوانده شده</p>
    @else
        <p class="text-warning text-center">کامنت های خوانده نشده</p>
    @endif
    @if(count($comments)!=0)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-danger btn-block"
                           href="{{route("admin/dash/comment/$comment[id]/status/0")}}">
                            رد کردن فوری!
                        </a>
